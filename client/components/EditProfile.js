...
class _EditProfile extends React.Component {
  ...
  handleSubmit(ev) {
    ...
    this.setState(Object.assign({}, this.state, { dispName: this.state.name, enableSave : true, message: 'Changes saved!' }));
  ...
  render() {
    ...
    return (
      <div id="profilecontainer">
        <div id="profileleft">
          <h1 className="profilehdr">Edit Profile</h1> 
...
{/*}            <div className="formfield">
    ...
    */}
              ...
              <select value={ this.state.state }
                      onChange={this.handleChange}>
                <option disabled key='0' value='0'> -- select a state -- </option>
